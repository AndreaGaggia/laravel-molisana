...
<section class="prodotti">
    ...
    <div class="prodotto" style="background-image: url({{ $prodotto['src'] }}); background-size: cover">
        <div class="overlay">
            <h3><a href="#">{{ $prodotto['titolo'] }}</a></h3>
            <svg class="mk-svg-icon" data-name="mk-li-food" data-cacheid="icon-60251d24bb2fb"
